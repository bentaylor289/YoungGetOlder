...
class AgeBudgetND(object):
    ...
    def aging(self):
        ...
        Aging = xr.where(self.snaps.Age_Sn==0, np.nan, 1/(360))
...
# Need to bring in both the velocities and the Age average values.
    ...
    def cal_ND_adv(self): 
        ...
        advx_nd_Age = self.terms.adv_x_Age - (self.dset.Age*div_u)*86400/self.volume
        advy_nd_Age = self.terms.adv_y_Age - (self.dset.Age*div_v)*86400/self.volume
        advr_nd_Age = self.terms.adv_r_Age - (self.dset.Age*div_w)*86400/self.volume
...
class OxygenBudget(object):
    ...
    def cal_ND_adv(self): 
        ...
        advx_nd_O2 = self.terms.adv_x_O2 - (self.dset.Oxygen*div_u)*86400/self.volume
        advy_nd_O2 = self.terms.adv_y_O2 - (self.dset.Oxygen*div_v)*86400/self.volume
        advr_nd_O2 = self.terms.adv_r_O2 - (self.dset.Oxygen*div_w)*86400/self.volume
